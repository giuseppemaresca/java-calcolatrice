...
public class CalcoliTestMain {
	...
	public static void main(String[] args) {
		// Prendiamo due numeri casuali e operiamo con essi
		Random random = new Random();
		int numeroRandom1 = random.nextInt((1000) + 1);
		int numeroRandom2 = random.nextInt((1000) + 1);
		System.out.println("I tuoi due numeri casuali sono : " + numeroRandom1 + " & " + numeroRandom2
				+ " e queste sono le operazioni con essi :");

		// somma fra i due numeri casuali
		...
		// Minimo fra i due valori casuali
		System.out
